...
import { ArrowDown, List, Lock, Mail, Percent, Phone, User } from "lucide-react";
...
export const CreateAdminForm = () => {
  ...
  const form = useForm({
    resolver: zodResolver(AdminSchema.register),
    defaultValues: {
      name: '',
      email: '',
      password: '',
  ...
  const createMutation = useMutation({
    mutationFn: ({ values }: { values: z.infer<typeof AdminSchema.register> }) => createAdmin(values),
    onSuccess: (data) => {
